package taskipsummanager.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("taskipsummanager.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("taskipsummanager.security.DomainUserDetailsService", "createSpringSecurityUser");
