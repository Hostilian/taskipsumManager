...
import static taskipsummanager.domain.TaskAsserts.*;
import static taskipsummanager.web.rest.TestUtil.createUpdateProxyForBean;
...
import taskipsummanager.IntegrationTest;
import taskipsummanager.domain.Task;
import taskipsummanager.repository.TaskRepository;
...
class TaskResourceIT {
    ...
    public static Task createEntity() {
        Task task = new Task().dueDate(DEFAULT_DUE_DATE).title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).completed(DEFAULT_COMPLETED);
        return task;
    }
    ...
    public static Task createUpdatedEntity() {
        Task task = new Task().dueDate(UPDATED_DUE_DATE).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).completed(UPDATED_COMPLETED);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.dueDate(UPDATED_DUE_DATE).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).completed(UPDATED_COMPLETED);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.dueDate(UPDATED_DUE_DATE).title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).completed(UPDATED_COMPLETED);
